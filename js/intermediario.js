...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ── DOM refs ──────────────────────────────────────────────────
    const progressBar = document.getElementById('int-progress-bar');
    const progressPct = document.getElementById('int-progress-pct');
    const progressMsg = document.getElementById('int-progress-msg');
    ...
    function updateProgress() {
        ...
        if (pct === 0) {
            ...
            progressMsg.textContent = '🎉 Todos os módulos concluídos! Nível intermediário completo.';
            progressMsg.style.color = 'var(--color-secondary)';
        }
